...
@@ -556,13 +556,13 @@ find_damaged_tiles (ClutterStageView      *view,
...
+#endif
   ...
   if (!prev_data)
     goto err_mmap_prev;
@@ -607,7 +607,7 @@ find_damaged_tiles (ClutterStageView      *view,
...
@@ -621,7 +621,7 @@ find_damaged_tiles (ClutterStageView      *view,
                  (*error)->message);
       g_clear_error (error);
     }
-
...
@@ -631,13 +631,16 @@ find_damaged_tiles (ClutterStageView      *view,
